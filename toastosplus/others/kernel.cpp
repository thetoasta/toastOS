...
#include "drivers/multiboot.hpp"
#include "drivers/time.hpp"
#include "drivers/fat16.hpp"
#include "drivers/font_renderer.hpp"
#include "drivers/JBFontData.hpp"
#include "drivers/registry.hpp"
#include "drivers/exec.hpp"
#include "drivers/editor.hpp"
#include "drivers/funcs.hpp"
#include "drivers/mmu.hpp"
#include "services/setup.hpp"
#include "drivers/string.hpp"
#include "drivers/user.hpp"
#include "drivers/paging.hpp"
#include "drivers/thread.hpp"
#include "drivers/syscall.hpp"
#include "drivers/posix.hpp"
...
void kmain(unsigned long magic, unsigned long addr)
{
    ...
    if (anotherflag && strcmp(anotherflag, "WK") == 0) {
        init_shell();
        kprint("you're running toastOS c++ ;)");
        kprint_newline();
    } else {
